<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="05_DemandaEjecutivaPagareBbvaAvalYExhorto.aspx.cs" Inherits="CobranzaALC.Cobranza.Demandas.Formatos._05_DemandaEjecutivaPagareBbvaAvalYExhorto" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <p style="text-align: justify; font-family: Verdana;">
                EN LO PRINCIPAL: Demanda ejecutiva y mandamiento de ejecución y embargo; PRIMER OTROSI: Bienes para el embargo; SEGUNDO OTROSI: Acompaña documentos en la forma legal y custodia; TERCERO OTROSI: Cuantía; CUARTO OTROSI: Personería; QUINTO  OTROSI: Patrocinio y Poder.
                <br />
            </p>
            ...
            <p style="text-align: justify; font-family: Verdana;">
                JOSE SANTANDER ROBLES, abogado, domiciliado en calle Estado Nº 359, Piso 13, Santiago, mandatario judicial y en representación convencional del BANCO BILBAO VIZCAYA ARGENTARIA, CHILE, Sociedad Anónima Bancaria, según consta en escritura pública que se acompaña en un otrosí de esta presentación, representada Legalmente por don Manuel Antonio Olivares Rossetti, Ingeniero Comercial, cédula de identidad número 8.496.988-, todos domiciliados para estos efectos en calle Barros Errázuriz Nº 1953, Piso 8º, comuna de Providencia, Región Metropolitana, a US. respetuosamente digo:
            </p>
            <p style="text-align: justify; font-family: Verdana;">
                Mi representado es dueño del siguiente pagaré suscrito por don (ña) CRISTIAN DOMINGO IRIBARREN TOLABA,  ignoro profesión u oficio, con domicilio en Coihueco Nº 550, Condominio Panorama, comuna de Arica, en calidad de deudor u obligado principal, y por doña MARISOL MINELA PASTEN RAMIREZ, ignoro profesión u oficio, con domicilio Coihueco Nº 550, Condominio Panorama, comuna de Arica, en calidad de  Aval y/o Codeudor Solidaria, y  cuyos términos son los siguientes:
            </p>
            <p style="text-align: justify; font-family: Verdana;">
                Pagaré B.B.V.A. número 0504-0470-62-9600007622,  suscrito por la cantidad de 192,55.- Unidades de Fomento por concepto de capital, y de 70,70 Unidades de Fomento por concepto de intereses, con fecha   29 de Diciembre de 2008.
            </p>
            <p style="text-align: justify; font-family: Verdana;">
                Sobre el capital adeudado se devengaría un interés del 9,2% anual, el cual se encuentra incorporado al valor final de cada una de las cuotas que a continuación se señalan. El pago, según describe, se efectuaría en 84 cuotas sucesivas, cuyo valor de cada una se encuentra en calendario de pago que forma parte del pagaré. El vencimiento para la primera cuota se fijo para el día 05 de febrero de 2009 y las restantes los días 05 de los meses siguientes.
            </p>
            <p style="text-align: justify; font-family: Verdana;">
                En caso que el suscriptor no pagase integra y oportunamente alguna (s) de las cuotas en la que se dividió la obligación, esta devengará desde el día de la mora y hasta el de su completo y efectivo pago, el interés corriente, que tuviere vigencia durante el tiempo de la mora o simple retardo, en sus diferentes etapas, más un 50% si esta ultima fuese superior a la primera.
            </p>
            <p style="text-align: justify; font-family: Verdana;">
            ...
            <p style="text-align: justify; font-family: Verdana;">
                La firma del suscriptor como la del codeudor solidario se encuentra autorizadas por notario público, por lo que el pagaré constituye titulo ejecutivo perfecto en su contra, siendo además, la obligación liquida, actualmente exigible y la acción ejecutiva no está prescrita. Se hace presente, que el deudor se encuentra en mora de la obligación a contar de la cuota Nº «N_CUOTA_MORA», con vencimiento de fecha «FECHA_MORA» en adelante, incumplimiento que faculta al Banco para exigir de inmediato, y como si fuera de plazo vencido, la totalidad de la deuda, por lo que vengo en exigir el pago total y anticipado de la obligación del pagaré, mediante la notificación de la presente demanda.
            </p>
            <p style="text-align: justify; font-family: Verdana;">
                Dicha deuda, de conformidad a la liquidación acompañada en un otrosí, de fecha «FECHA_LIQUIDACIÓN», y de conformidad a lo establecido en el artículo 30 de la Ley 18.010,  asciende a la cantidad $«MONTO_DEUDA_LIQUIDACIÓN».-, correspondiente a capital adeudado por concepto de cuotas vencidas y no vencidas. A la suma señalada se le debe adicionar los intereses convencionales y penales que se generen a contar desde la mora, hasta la fecha del pago efectivo de la deuda mas las costas del juicio.
            </p>
            <p style="text-align: center; font-family: Verdana;">
            ...
            <p style="text-align: justify; font-family: Verdana;">
                <strong>RUEGO A US.</strong>, tener por entablada demanda ejecutiva y despachar mandamiento de ejecución y embargo en contra de don(ña)  CRISTIAN DOMINGO IRIBARREN TOLABA, y en contra de doña MARISOL MINELA PASTEN RAMIREZ, ambos ya debidamente individualizados, en su calidad de suscriptor y deudor principal del pagare singularizado, y el segundo en su calidad de aval y codeudor solidario, por la suma de 91,70.- Unidades de Fomento.- correspondiente a capital adeudado vencido y capital adeudado no vencido de conformidad a lo establecido en el artículo 30 de la Ley 18010; todo ello más los intereses correspondientes, que se generan a contar desde la mora y hasta la fecha del pago efectivo de la deuda, mas las costas del juicio y disponer que se continúe la ejecución, acogiendo la demanda en todas sus partes, hasta que se haga a mi representado entero pago de sus acreencias, con costas.   
            </p>
            <p style="text-align: justify; font-family: Verdana;">
            ...
            <p style="text-align: justify; font-family: Verdana;">
                <strong>SEGUNDO OTROSI:</strong> Ruego a S.S. tener por acompañados en la forma legal y ordenar la custodia de los siguientes documentos:
            </p>
            <p style="text-align: justify; font-family: Verdana;">
                1.- Con citación, Pagaré B.B.V.A. numero 0504-0470-62-9600007622.
            </p>
            <p style="text-align: justify; font-family: Verdana;">
                2.- Bajo apercibimiento del articulo 346 N° 3 del Código de Procedimiento Civil, liquidación del pagaré numero de Obligación 0504-0470-62-9600007622
            </p>
            <p style="text-align: justify; font-family: Verdana;">
                3.- Con citación, copia autorizada de mi personería para representar a Banco Bilbao Vizcaya Argentaria, Chile que consta de la escritura de fecha 22 de Enero de 2014, otorgada en la Notaria de Santiago, de don Eduardo Avello Concha.
            </p>
            <p style="text-align: justify; font-family: Verdana;">
            ...
            <p style="text-align: justify; font-family: Verdana;">
                <strong>SEXTO OTROSI: </strong>Ruego a SS., tener presente que en mi calidad de abogado habilitado, asumo personalmente el patrocinio y poder en esta causa, y a la vez confiero poder al abogado don CLAUDIO VILLARROEL MELENDEZ, de mi mismo domicilio, pudiendo actuar de manera conjunta o separada indistintamente con el suscrito.
            </p>
        </div>
    </form>
</body>
