<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RetiroDeDemanda.aspx.cs" Inherits="CobranzaALC.Cobranza.Documentos.Formatos.DocumentosTres.RetiroDeDemanda" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <br />
        <p style="text-align: justify; font-family: Verdana;">
            Que, no encontrándose notificada la demanda de autos, vengo en solicitar a SS se sirva autorizar el retiro de esta, como también el ordenar hacerme devolución del pagaré materia de esta ejecución.
        </p>
        <br />
        <p style="text-align: center; font-family: Verdana;">
            <strong>POR TANTO,
