<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SeResuelvaBases.aspx.cs" Inherits="CobranzaALC.Cobranza.Documentos.Formatos.DocumentosDos.SeResuelvaBases" %>
...
<body>
    <form id="form1" runat="server">
        <p style="text-align: justify; font-family: Verdana;"><strong>SOLICITA SE RESUELVAN BASES DE REMATE.-</strong>
        </p>
        <br />
        ...
        <br />
        <p style="text-align: justify; font-family: Verdana;">
            Sírvase SS. resolver derechamente  las bases de remate presentadas con fecha ____________, por esta parte. 
        </p>
        <br />
        <p style="text-align: center; font-family: Verdana;">
