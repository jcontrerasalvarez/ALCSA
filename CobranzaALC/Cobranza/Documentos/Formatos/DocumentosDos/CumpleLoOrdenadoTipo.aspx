<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CumpleLoOrdenadoTipo.aspx.cs" Inherits="CobranzaALC.Cobranza.Documentos.Formatos.DocumentosDos.CumpleLoOrdenadoTipo" %>
...
<body>
    <form id="form1" runat="server">
        <p style="text-align: left; font-family: Verdana;"><strong>CUMPLE LO ORDENADO Y SE RESUELVA DERECHAMENTE.-</strong>
        </p>
        ...
        <br />
        <p style="text-align: justify; font-family: Verdana;">
            Que vengo en cumplir con lo ordenado por SS. en el sentido de________________________.
        </p>
        <br />
        <p style="text-align: center; font-family: Verdana;">
            <strong>POR TANTO,
        ...
        <br />
        <p style="text-align: justify; font-family: Verdana;">
            <strong>RUEGO A US.</strong> tener por cumplido lo ordenado y se resuelva derechamente la demanda de autos .-
        </p>
    </form>
</body>
</html>
