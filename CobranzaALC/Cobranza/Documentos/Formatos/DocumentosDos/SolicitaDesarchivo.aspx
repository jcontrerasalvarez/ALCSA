<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SolicitaDesarchivo.aspx.cs" Inherits="CobranzaALC.Cobranza.Documentos.Formatos.DocumentosDos.SolicitaDesarchivo" %>
...
<body>
    <form id="form1" runat="server">
        <p style="text-align: justify; font-family: Verdana;"><strong>SOLICITA DESARCHIVO PARA LOS EFECTOS QUE INDICA.-</strong>
        </p>
        <br />
        ...
        <br />
        <p style="text-align: justify; font-family: Verdana;">
            _______________________________________, vengo en solicitar el desarchivo de la presente causa  la que  se encuentra en el  Archivo Judicial  legajo  nº ____________
        </p>
        <br />
        <p style="text-align: center; font-family: Verdana;">
        ...
        <br />
        <p style="text-align: justify; font-family: Verdana;">
            <strong>RUEGO A US.</strong> acceder a lo solicitado, ordenando el desarchivo de la presente causa. “ lo manuscrito vale”
        </p>
    </form>
</body>
</html>
