<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SeCertificaPagareNoExcepcionesTipo.aspx.cs" Inherits="CobranzaALC.Cobranza.Documentos.Formatos.DocumentosDos.SeCertificaPagareNoExcepcionesTipo" %>
...
<body>
    <form id="form1" runat="server">
        <p style="text-align: left; font-family: Verdana;">
            <strong>CERTIFICACIÓN QUE INDICA.-</strong>
        </p>
        <br />
        ...
        <br />
        <p style="text-align: justify; font-family: Verdana;">
            Que vengo en solicitar a US. se sirva ordenar se certifique por el Sr(a). Secretario (a) del Tribunal, como es efectivo que el demandado no ha opuesto excepciones dentro del plazo legal, el que se encuentra vencido.
        </p>
        <br />
        <p style="text-align: center; font-family: Verdana;">
            <strong>POR TANTO;
