<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AmpliacionEmbargoInmuebleExhorto.aspx.cs" Inherits="CobranzaALC.Cobranza.Documentos.Formatos.DocumentosSeis.AmpliacionEmbargoInmuebleExhorto" %>
    ...
    <form id="form1" runat="server">
        <div>
            <p style="text-align: left; font-family: Verdana;">
                <strong>EN LO PRINCIPAL:</strong> AMPLIACION DE EMBARGO; <strong>PRIMER OTROSI:</strong> ACOMPAÑA DOCUMENTOS; SEGUNDO OTROSI: EXHORTO.- 
            </p>
            <br />
            <br />
            ...
            <p style="text-align: justify; font-family: Verdana;">
                <strong>SEGUNDO OTROSI:</strong> Que habida consideración del merito de autos, según el cual consta que el demandado ha sido notificado y requerido de pago, vengo en solicitar a SS., se sirva exhortar al Juez de Turno en lo Civil de ______________________ con la finalidad de proceder al embargo del inmueble individualizado en lo principal de esta presentación. El tribunal exhortado tendrá las más amplias facultades, pudiendo resolver todo tipo de petición que tengan por finalidad el dar cumplimiento al mandamiento de ejecución y embargo despachado, y especialmente disponer la inscripción de embargos de inmuebles o de cualquier otro tipo de bien cuyo embargo deba ser inscrito en algún registro o repartición. Dicho exhorto deberá contener copia autorizada de la demanda ejecutiva, resolución, mandamiento y toda otra actuación pertinente y podrá ser tramitado por quien lo presente o requiera.  
            </p>
        </div>
    </form>
</body>
