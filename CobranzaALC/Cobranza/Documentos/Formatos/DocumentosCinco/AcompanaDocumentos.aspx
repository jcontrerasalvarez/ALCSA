<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AcompanaDocumentos.aspx.cs" Inherits="CobranzaALC.Cobranza.Documentos.Formatos.DocumentosCinco.AcompanaDocumentos" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            <p style="text-align: justify; font-family: Verdana;">
                Que vengo en cumplir con lo ordenado por SS., en el sentido de acompañar todos y cada uno de los documentos ofrecidos en la demanda de autos.
            </p>
            <br />
            <p style="text-align: center; font-family: Verdana;">
                <strong>POR TANTO,
