                ...
                <tr>
                    <td align="center">
                        <asp:ListBox ID="lstTiposDocumentos" runat="server" Height="200px" Width="97%" CssClass="listado-documentos">
                            ...
                            <asp:ListItem Value="Formatos/PruebaDocumentos/AcompañaDocumentosTannerFactorline.aspx">Acompaña Documentos Tanner Factorline</asp:ListItem>
                            <asp:ListItem Value="Formatos/PruebaDocumentos/AcompañaDocumentoTannerAutofin.aspx">Acompaña Documento Tanner Autofin</asp:ListItem>
                            <asp:ListItem Value="Formatos/PruebaDocumentos/CertificadoEjecutoriaAvenimiento.aspx">Certificado Ejecutoria Avenimiento</asp:ListItem>
                            <asp:ListItem Value="Formatos/PruebaDocumentos/CursoProgresivo.aspx">Curso Progresivo</asp:ListItem>
                            <asp:ListItem Value="Formatos/PruebaDocumentos/DevuelveExhortoDiligenciaYSolicitaExhortoRetiroAuto.aspx">Devuelve Exhorto Diligencia Y Solicita Exhorto Retiro Auto</asp:ListItem>
                            <asp:ListItem Value="Formatos/PruebaDocumentos/EscritoPilotoRetiroDeTitulosBECO.aspx">Escrito Piloto Retiro De Titulos BECO</asp:ListItem>
                            <asp:ListItem Value="Formatos/PruebaDocumentos/RatificaFirma.aspx">RatificaFirma</asp:ListItem>
                            <asp:ListItem Value="Formatos/PruebaDocumentos/ReceptorAdHoc.aspx">ReceptorAdHoc</asp:ListItem>
                            <asp:ListItem Value="Formatos/PruebaDocumentos/SolicitudAlzamientoInmuebleCorvalanPulgar.aspx">Solicitud Alzamiento Inmueble Corvalan Pulgar</asp:ListItem>
                        </asp:ListBox>
                    </td>
                </tr>
            </table>
